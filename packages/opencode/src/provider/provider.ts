        ...
        yield* Effect.promise(async () => {
          ...
          if (claudePath) {
            ...
            providers[id] = {
              ...
              models: {
                "claude-opus-4-7":         cliModel(id, "claude-opus-4-7",         "Claude Opus 4.7",            "claude", 200),
                "claude-opus-4-7-low":     cliModel(id, "claude-opus-4-7-low",     "Claude Opus 4.7 (low)",      "claude", 200),
                "claude-opus-4-7-medium":  cliModel(id, "claude-opus-4-7-medium",  "Claude Opus 4.7 (medium)",   "claude", 200),
                "claude-opus-4-7-high":    cliModel(id, "claude-opus-4-7-high",    "Claude Opus 4.7 (high)",     "claude", 200),
                "claude-opus-4-7-xhigh":   cliModel(id, "claude-opus-4-7-xhigh",   "Claude Opus 4.7 (xhigh)",    "claude", 200),
                "claude-opus-4-7-max":     cliModel(id, "claude-opus-4-7-max",     "Claude Opus 4.7 (max)",      "claude", 200),
                "claude-sonnet-4-6":        cliModel(id, "claude-sonnet-4-6",       "Claude Sonnet 4.6",           "claude", 200),
                "claude-sonnet-4-6-low":    cliModel(id, "claude-sonnet-4-6-low",   "Claude Sonnet 4.6 (low)",     "claude", 200),
                "claude-sonnet-4-6-medium": cliModel(id, "claude-sonnet-4-6-medium","Claude Sonnet 4.6 (medium)",  "claude", 200),
                "claude-sonnet-4-6-high":   cliModel(id, "claude-sonnet-4-6-high",  "Claude Sonnet 4.6 (high)",    "claude", 200),
                "claude-sonnet-4-6-max":    cliModel(id, "claude-sonnet-4-6-max",   "Claude Sonnet 4.6 (max)",     "claude", 200),
                "claude-haiku-4-5":         cliModel(id, "claude-haiku-4-5",        "Claude Haiku 4.5",            "claude", 200),
              },
            }
            log.info("found", { providerID: id })
          }
          ...
          if (codexPath) {
            ...
            providers[id] = {
              ...
              models: {
                "gpt-5.5":            cliModel(id, "gpt-5.5",            "gpt-5.5",                "codex", 200),
                "gpt-5.5-low":        cliModel(id, "gpt-5.5-low",        "gpt-5.5 (low)",          "codex", 200),
                "gpt-5.5-medium":     cliModel(id, "gpt-5.5-medium",     "gpt-5.5 (medium)",       "codex", 200),
                "gpt-5.5-high":       cliModel(id, "gpt-5.5-high",       "gpt-5.5 (high)",         "codex", 200),
                "gpt-5.5-xhigh":      cliModel(id, "gpt-5.5-xhigh",      "gpt-5.5 (xhigh)",        "codex", 200),
                "gpt-5.4":            cliModel(id, "gpt-5.4",            "gpt-5.4",                "codex", 128),
                "gpt-5.4-low":        cliModel(id, "gpt-5.4-low",        "gpt-5.4 (low)",          "codex", 128),
                "gpt-5.4-medium":     cliModel(id, "gpt-5.4-medium",     "gpt-5.4 (medium)",       "codex", 128),
                "gpt-5.4-high":       cliModel(id, "gpt-5.4-high",       "gpt-5.4 (high)",         "codex", 128),
                "gpt-5.4-xhigh":      cliModel(id, "gpt-5.4-xhigh",      "gpt-5.4 (xhigh)",        "codex", 128),
                "gpt-5.4-mini":        cliModel(id, "gpt-5.4-mini",       "gpt-5.4-mini",            "codex", 128),
                "gpt-5.4-mini-low":    cliModel(id, "gpt-5.4-mini-low",   "gpt-5.4-mini (low)",      "codex", 128),
                "gpt-5.4-mini-medium": cliModel(id, "gpt-5.4-mini-medium","gpt-5.4-mini (medium)",   "codex", 128),
                "gpt-5.4-mini-high":   cliModel(id, "gpt-5.4-mini-high",  "gpt-5.4-mini (high)",     "codex", 128),
                "gpt-5.4-mini-xhigh":  cliModel(id, "gpt-5.4-mini-xhigh", "gpt-5.4-mini (xhigh)",    "codex", 128),
                "gpt-5.3-codex":       cliModel(id, "gpt-5.3-codex",      "gpt-5.3-codex",           "codex", 200),
                "gpt-5.3-codex-low":   cliModel(id, "gpt-5.3-codex-low",  "gpt-5.3-codex (low)",     "codex", 200),
                "gpt-5.3-codex-medium":cliModel(id, "gpt-5.3-codex-medium","gpt-5.3-codex (medium)",  "codex", 200),
                "gpt-5.3-codex-high":  cliModel(id, "gpt-5.3-codex-high", "gpt-5.3-codex (high)",    "codex", 200),
                "gpt-5.3-codex-xhigh": cliModel(id, "gpt-5.3-codex-xhigh","gpt-5.3-codex (xhigh)",   "codex", 200),
                "gpt-5.2":            cliModel(id, "gpt-5.2",            "gpt-5.2",                "codex", 128),
                "gpt-5.2-low":        cliModel(id, "gpt-5.2-low",        "gpt-5.2 (low)",          "codex", 128),
                "gpt-5.2-medium":     cliModel(id, "gpt-5.2-medium",     "gpt-5.2 (medium)",       "codex", 128),
                "gpt-5.2-high":       cliModel(id, "gpt-5.2-high",       "gpt-5.2 (high)",         "codex", 128),
                "gpt-5.2-xhigh":      cliModel(id, "gpt-5.2-xhigh",      "gpt-5.2 (xhigh)",        "codex", 128),
              },
            }
            log.info("found", { providerID: id })
          }
