export const dict = {
  ...
  "ui.sessionTurn.status.debating": "Equipo debatiendo · Ronda {{round}}/{{total}}",
  "dialog.team.select.title": "Seleccionar equipo",
  "dialog.team.select.confirm": "Activar equipo ({{count}} modelos)",
  "dialog.team.select.needsTwo": "Selecciona al menos 2 modelos",
  "dialog.team.clear": "Limpiar",
  "command.team.choose": "Seleccionar equipo",
  "command.team.choose.description": "Elige un equipo de modelos para el debate Conclave",
  "prompt.team.active": "Equipo: {{count}} modelos",
