export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.debating": "Team debating · Round {{round}}/{{total}}",
  "dialog.team.select.title": "Select team",
  "dialog.team.select.confirm": "Set team ({{count}} models)",
  "dialog.team.select.needsTwo": "Select at least 2 models",
  "dialog.team.clear": "Clear",
  "command.team.choose": "Select team",
  "command.team.choose.description": "Choose a team of models for Conclave debate",
  "prompt.team.active": "Team: {{count}} models",
